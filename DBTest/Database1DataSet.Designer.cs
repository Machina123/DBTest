...
namespace DBTest {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public TableRow AddTableRow(string Name, string Surname, string PhoneNo) {
...
namespace DBTest.Database1DataSetTableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Table] WHERE (([Id] = @Original_Id) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Surname = 1 AND [Surname] IS NULL) OR ([Surname] = @Original_Surname)) AND ((@IsNull_PhoneNo = 1 AND [PhoneNo] IS NULL) OR ([PhoneNo] = @Original_PhoneNo)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([Id], [Name], [Surname], [PhoneNo]) VALUES (@Id, @Name" +
                ", @Surname, @PhoneNo);\r\nSELECT Id, Name, Surname, PhoneNo FROM [Table] WHERE (Id" +
                " = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [Id] = @Id, [Name] = @Name, [Surname] = @Surname, [PhoneNo] = @PhoneNo WHERE (([Id] = @Original_Id) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Surname = 1 AND [Surname] IS NULL) OR ([Surname] = @Original_Surname)) AND ((@IsNull_PhoneNo = 1 AND [PhoneNo] IS NULL) OR ([PhoneNo] = @Original_PhoneNo)));
SELECT Id, Name, Surname, PhoneNo FROM [Table] WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::DBTest.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Surname, PhoneNo FROM dbo.[Table]";
        ...
        public virtual int Delete(int Original_Id, string Original_Name, string Original_Surname, string Original_PhoneNo) {
        ...
        public virtual int Insert(int Id, string Name, string Surname, string PhoneNo) {
        ...
        public virtual int Update(int Id, string Name, string Surname, string PhoneNo, int Original_Id, string Original_Name, string Original_Surname, string Original_PhoneNo) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Surname, string PhoneNo, int Original_Id, string Original_Name, string Original_Surname, string Original_PhoneNo) {
            return this.Update(Original_Id, Name, Surname, PhoneNo, Original_Id, Original_Name, Original_Surname, Original_PhoneNo);
        }
    }
